  ...
  async function createUser(req, res) {
    try {
      ...
      if (existingUser) {
        ...
        const waiters = await admin_service.listWaiters();
        res.render('admin', { username, waiters, message: 'User with this username already exists' });
      } else {
      ...
      console.error(error);
      const waiters = await admin_service.listWaiters();
      res.render('admin', { message: 'User with this username already exists', waiters });
    }
  }
